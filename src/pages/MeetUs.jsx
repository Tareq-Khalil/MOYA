...
const team = [
  {
    ...
    bio: 'A Full-Stack Web Developer who spends most of his time leveling up different tech skill trees: Machine Learning Engineer, Game Developer, App Developer, and Data Analyst. Think of it like grinding multiple classes in an RPG until the build becomes slightly overpowered.\nI’m also an otaku and animator, so most of my inspiration comes from anime, late-night coding arcs, and the belief that every project deserves at least a little main-character energy.',
